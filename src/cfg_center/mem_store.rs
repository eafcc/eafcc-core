use crate::{cfg_center::cfgindex, error::MemoryIndexError, storage_backends::StorageBackend};
...
impl MemStorage {
    pub fn new(backend: &dyn StorageBackend, namespace: &str, version: &str) -> Result<Self> {
